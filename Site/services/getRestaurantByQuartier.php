<?php
/**
 * Service de récupération des Restaurants d'un quartier
 * 
 * @api services/getRestaurantByQuartier [GET]
...
if (isset($_GET['quartier'])) {
    $responses = $quartierDAO->getRestaurantByQuartier($_GET['quartier'], $_SESSION["idLang"]);
    $array = array();
    if ($responses != false) {
