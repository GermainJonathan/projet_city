...
class quartierDAO extends DAO
{
    ...
    public function getRestaurantByQuartier($libelleQuartier){
        ...
        foreach ($result as $temp){
            $listRestaurant[] = new restaurant($temp['codeRestaurant'], $temp['codePays'], $temp['codeQuartier'], $quartier->getLibelleQuartier(), $temp['nom'], $temp['numeroTelephone'], $temp['imageRestaurant'], $temp['adresse'], $temp['commentaire']);
        }
