...
(1, 1, 3, 'Hôtel de ville de Lyon', 'hotel-de-ville-lyon-1.jpg', GeomFromText('POINT(45.7677074 4.835709100000031)'), '1672-01-01', 'Simon Maupin', NULL),
(2, 1, 1, 'Statue de la République', 'statut-de-la-republique.jpg', GeomFromText('POINT(45.7508908 4.828135800000041)'), '1880-01-01', 'Victor-Auguste Blavette', NULL);
...
(1, 1, 1, 100, 'Le Musée des Tissus et des Arts Décoratifs', NULL, GeomFromText('POINT(45.7532337 4.831183300000021)'), 'musee-tissu-lyon.jpg', NULL);
