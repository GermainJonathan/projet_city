...
<div id="textMentionsLegales">
    <div id="imgMentionsLégales">
        <div class="introMentions"> 
            ...
            <p> Merci de lire attentivement les modalités d’utilisation suivantes avant toute utilisation du site. </p>
        </div>
    </div>
    <div class="col-8 offset-2 lesMentionsLegales">
        ...
        <div class="TitreMentionsLegales"><h2>Limitation de responsabilité</h2></div>
        ...
        <div class="TitreMentionsLegales"><h2>Confidentialité</h2></div>
        ...
        <div class="TitreMentionsLegales"><h2>Conditions de service</h2></div>
        ...
        <div class="TitreMentionsLegales"><h3>Liens hypertextes</h3></div>
        ...
        <div class="TitreMentionsLegales"><h3>Responsabilité</h3></div>
