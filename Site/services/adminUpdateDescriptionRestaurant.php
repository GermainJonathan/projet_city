...
if (isset($data->idRestaurant) && isset($data->description) && isset($data->title)) {
    $responses = $quartierDAO->setDescriptionRestaurant($data->idRestaurant, $data->description, $data->title);
    if($responses) {
