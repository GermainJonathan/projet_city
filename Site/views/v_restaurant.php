...
<div class="modal fade" id="SavoirPlusmodal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-content">
            <div class="modal-header modalSavoirPlus">
                <h5 class="modal-title" id="titreSavoirPlusModal"></h5>
                <button type="button" class="closeBtnSavoirPlus" data-dismiss="modal" aria-label="Close">
