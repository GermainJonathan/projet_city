    ...
    <div class="row no-padding no-margin">
            ...
            <div class="toSpinCard" id="toSpinCard0">
                <div class="card-font card-back-face"> 
                    <div class="list-group list-group-flush">
                        <a href="?page=terreaux#anchorBodyMonuments" class="list-group-item"><?= MENU_TERREAUX ?></a>
                        <a href="?page=bellecour#anchorBodyMonuments" class="list-group-item"><?= MENU_BELLECOUR ?></a>
                        <a href="?page=perrache#anchorBodyMonuments" class="list-group-item"><?= MENU_PERRACHE ?></a>
                    </div>
                </div>
        ...
        <div class="iconPatrimoine col-lg-3 col-md-6 col-sm-6" data-index="1">
            <div class="toSpinCard" id="toSpinCard1">
                <div class="card-font card-back-face"> 
                    <div class="list-group list-group-flush">
                        <a href="?page=terreaux#anchorBodyActivites" class="list-group-item"><?= MENU_TERREAUX ?></a>
                        <a href="?page=bellecour#anchorBodyActivites" class="list-group-item"><?= MENU_BELLECOUR ?></a>
                        <a href="?page=perrache#anchorBodyActivites" class="list-group-item"><?= MENU_PERRACHE ?></a>
                    </div>
                </div>
                <div class="card-font card-font-face">
                    <div class="col-lg-12 d-flex justify-content-center">
        ...
        <div class="iconPatrimoine col-lg-3 col-md-6 col-sm-6" data-index="2">
            <div class="toSpinCard" id="toSpinCard2">
                <div class="card-font card-back-face"> 
                    <div class="list-group list-group-flush">
                        <a href="?page=terreaux#anchorBodyHistoire" class="list-group-item"><?= MENU_TERREAUX ?></a>
                        <a href="?page=bellecour#anchorBodyHistoire" class="list-group-item"><?= MENU_BELLECOUR ?></a>
                        <a href="?page=perrache#anchorBodyHistoire" class="list-group-item"><?= MENU_PERRACHE ?></a>
                    </div>
                </div>
                <div class="card-font card-font-face">
                    <div class = "col-lg-12 d-flex justify-content-center">
        ...
        <div class="iconPatrimoine col-lg-3 col-md-6 col-sm-6" data-index="3">
            <div class="toSpinCard" id="toSpinCard3">
                <div class="card-font card-back-face"> 
                    <div class="list-group list-group-flush">
                        <a href="?page=terreaux#anchorBodyRestaurants" class="list-group-item"><?= MENU_TERREAUX ?></a>
                        <a href="?page=bellecour#anchorBodyRestaurants" class="list-group-item"><?= MENU_BELLECOUR ?></a>
                        <a href="?page=perrache#anchorBodyRestaurants" class="list-group-item"><?= MENU_PERRACHE ?></a>
                    </div>
                </div>  
                <div class="card-font card-font-face">
                    <div class = "col-lg-12 d-flex justify-content-center">
